...
public class TestController {
    ...
    @PreAuthorize("hasAnyAuthority('TESTENTITY_CREATE')")
    ...
    // ------------ Delete test ------------
    @PreAuthorize("hasAnyAuthority('TESTENTITY_DELETE')")
    ...
    // ------------ Update test ------------
    @PreAuthorize("hasAnyAuthority('TESTENTITY_UPDATE')")
    @RequestMapping(
        value = "/{id}",
    ...
    @PreAuthorize("hasAnyAuthority('TESTENTITY_READ')")
    @RequestMapping(
        value = "/{id}",
